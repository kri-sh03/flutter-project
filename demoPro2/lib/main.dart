...
void main() async {
  ...
  //   // ShowPushNotification.showNotification(fileName: message);
  // }
...
class MyApp extends StatelessWidget {
  ...
  getConnectivityInstance(context) async {
    try {
  ...
  netWorkVerify(context) async {
    await getConnectivityInstance(context);
