...
pickFileBottomSheet(context, func, [bool noNeedPdf = false]) {
  Future<void> captureImage(source) async {
    ...
    try {
      ...
      if (path != null) {
        ...
        size > (5 * 1024 * 1024)
            ? showSnackbar(
                context, "file size must be less then 5MB", Colors.red)
            : func(path);
      ...
      String message = e.toString().contains("PdfRendererException") ||
          ...
          : "Some thing went wrong please upload another file";
